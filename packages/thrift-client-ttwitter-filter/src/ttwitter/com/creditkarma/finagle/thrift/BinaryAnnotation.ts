...
export interface IBinaryAnnotation {
    key?: string;
    value?: Buffer;
    annotation_type?: __NAMESPACE__.AnnotationType;
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.TType.I32) {
                        const value_3: __NAMESPACE__.AnnotationType = input.readI32();
                ...
                case 4:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_4: __NAMESPACE__.IEndpoint = __NAMESPACE__.EndpointCodec.decode(input);
                        _args.host = value_4;
                    }
                    else {
                        input.skip(fieldType);
...
export class BinaryAnnotation implements thrift.IStructLike, IBinaryAnnotation {
    public key?: string;
    public value?: Buffer;
    public annotation_type?: __NAMESPACE__.AnnotationType;
    ...
    constructor(args: IBinaryAnnotationArgs = {}) {
        ...
        if (args.annotation_type != null) {
            const value_7: __NAMESPACE__.AnnotationType = args.annotation_type;
            this.annotation_type = value_7;
        }
        if (args.host != null) {
            const value_8: __NAMESPACE__.IEndpoint = new __NAMESPACE__.Endpoint(args.host);
            this.host = value_8;
        }
    }
