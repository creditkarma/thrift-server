...
export interface IRequestHeader {
    ...
    sampled?: boolean;
    client_id?: ClientId.IClientId;
    flags?: thrift.Int64;
    contexts?: Array<RequestContext.IRequestContext>;
    dest?: string;
    delegations?: Array<Delegation.IDelegation>;
}
...
export const RequestHeaderCodec: thrift.IStructCodec<IRequestHeaderArgs, IRequestHeader> = {
    encode(args: IRequestHeaderArgs, output: thrift.TProtocol): void {
        ...
        if (obj.contexts != null) {
            ...
            obj.contexts.forEach((value_1: RequestContext.IRequestContextArgs): void => {
                RequestContext.RequestContextCodec.encode(value_1, output);
            });
            output.writeListEnd();
            output.writeFieldEnd();
        }
        ...
        if (obj.delegations != null) {
            ...
            obj.delegations.forEach((value_2: Delegation.IDelegationArgs): void => {
                Delegation.DelegationCodec.encode(value_2, output);
            });
            output.writeListEnd();
            output.writeFieldEnd();
        }
            ...
            switch (fieldId) {
                ...
                case 6:
                    if (fieldType === thrift.TType.STRUCT) {
                        const value_7: ClientId.IClientId = ClientId.ClientIdCodec.decode(input);
                ...
                case 8:
                    if (fieldType === thrift.TType.LIST) {
                        const value_9: Array<RequestContext.IRequestContext> = new Array<RequestContext.IRequestContext>();
                        const metadata_1: thrift.IThriftList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_10: RequestContext.IRequestContext = RequestContext.RequestContextCodec.decode(input);
                ...
                case 10:
                    if (fieldType === thrift.TType.LIST) {
                        const value_12: Array<Delegation.IDelegation> = new Array<Delegation.IDelegation>();
                        const metadata_2: thrift.IThriftList = input.readListBegin();
                        const size_2: number = metadata_2.size;
                        for (let i_2: number = 0; i_2 < size_2; i_2++) {
                            const value_13: Delegation.IDelegation = Delegation.DelegationCodec.decode(input);
...
export class RequestHeader extends thrift.StructLike implements IRequestHeader {
    ...
    public client_id?: ClientId.IClientId;
    public flags?: thrift.Int64;
    public contexts?: Array<RequestContext.IRequestContext>;
    public dest?: string;
    public delegations?: Array<Delegation.IDelegation>;
    ...
    constructor(args: IRequestHeaderArgs = {}) {
        ...
        if (args.client_id != null) {
            const value_18: ClientId.IClientId = new ClientId.ClientId(args.client_id);
        ...
        if (args.contexts != null) {
            const value_20: Array<RequestContext.IRequestContext> = new Array<RequestContext.IRequestContext>();
            args.contexts.forEach((value_23: RequestContext.IRequestContextArgs): void => {
                const value_24: RequestContext.IRequestContext = new RequestContext.RequestContext(value_23);
        ...
        if (args.delegations != null) {
            const value_22: Array<Delegation.IDelegation> = new Array<Delegation.IDelegation>();
            args.delegations.forEach((value_25: Delegation.IDelegationArgs): void => {
                const value_26: Delegation.IDelegation = new Delegation.Delegation(value_25);
