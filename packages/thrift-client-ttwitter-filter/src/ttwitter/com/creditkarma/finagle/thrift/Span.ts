...
import * as BinaryAnnotation from "./BinaryAnnotation";
export interface ISpan {
    trace_id?: thrift.Int64;
    name?: string;
    id?: thrift.Int64;
    parent_id?: thrift.Int64;
    annotations?: Array<Annotation.IAnnotation>;
    binary_annotations?: Array<BinaryAnnotation.IBinaryAnnotation>;
    debug?: boolean;
}
export interface ISpanArgs {
    ...
    annotations?: Array<Annotation.IAnnotationArgs>;
    binary_annotations?: Array<BinaryAnnotation.IBinaryAnnotationArgs>;
    debug?: boolean;
}
            ...
            switch (fieldId) {
                ...
                case 6:
                    if (fieldType === thrift.TType.LIST) {
                        const value_7: Array<Annotation.IAnnotation> = new Array<Annotation.IAnnotation>();
                        const metadata_1: thrift.IThriftList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_8: Annotation.IAnnotation = Annotation.AnnotationCodec.decode(input);
                ...
                case 8:
                    if (fieldType === thrift.TType.LIST) {
                        const value_9: Array<BinaryAnnotation.IBinaryAnnotation> = new Array<BinaryAnnotation.IBinaryAnnotation>();
                        const metadata_2: thrift.IThriftList = input.readListBegin();
                        const size_2: number = metadata_2.size;
                        for (let i_2: number = 0; i_2 < size_2; i_2++) {
                            const value_10: BinaryAnnotation.IBinaryAnnotation = BinaryAnnotation.BinaryAnnotationCodec.decode(input);
...
export class Span extends thrift.StructLike implements ISpan {
    ...
    public annotations?: Array<Annotation.IAnnotation>;
    public binary_annotations?: Array<BinaryAnnotation.IBinaryAnnotation>;
    ...
    constructor(args: ISpanArgs = {}) {
        ...
        if (args.annotations != null) {
            const value_16: Array<Annotation.IAnnotation> = new Array<Annotation.IAnnotation>();
            args.annotations.forEach((value_19: Annotation.IAnnotationArgs): void => {
                const value_20: Annotation.IAnnotation = new Annotation.Annotation(value_19);
                value_16.push(value_20);
            });
            this.annotations = value_16;
        }
        if (args.binary_annotations != null) {
            const value_17: Array<BinaryAnnotation.IBinaryAnnotation> = new Array<BinaryAnnotation.IBinaryAnnotation>();
            args.binary_annotations.forEach((value_21: BinaryAnnotation.IBinaryAnnotationArgs): void => {
                const value_22: BinaryAnnotation.IBinaryAnnotation = new BinaryAnnotation.BinaryAnnotation(value_21);
