...
export class Annotation extends thrift.StructLike implements IAnnotation {
    ...
    constructor(args: IAnnotationArgs = {}) {
        ...
        if (args.timestamp != null) {
            const value_10: thrift.Int64 = (typeof args.timestamp === "number" ? new thrift.Int64(args.timestamp) : typeof args.timestamp === "string" ? thrift.Int64.fromDecimalString(args.timestamp) : args.timestamp);
...
export class Span extends thrift.StructLike implements ISpan {
    ...
    constructor(args: ISpanArgs = {}) {
        ...
        if (args.trace_id != null) {
            const value_32: thrift.Int64 = (typeof args.trace_id === "number" ? new thrift.Int64(args.trace_id) : typeof args.trace_id === "string" ? thrift.Int64.fromDecimalString(args.trace_id) : args.trace_id);
        ...
        if (args.id != null) {
            const value_34: thrift.Int64 = (typeof args.id === "number" ? new thrift.Int64(args.id) : typeof args.id === "string" ? thrift.Int64.fromDecimalString(args.id) : args.id);
            this.id = value_34;
        }
        if (args.parent_id != null) {
            const value_35: thrift.Int64 = (typeof args.parent_id === "number" ? new thrift.Int64(args.parent_id) : typeof args.parent_id === "string" ? thrift.Int64.fromDecimalString(args.parent_id) : args.parent_id);
...
export class RequestHeader extends thrift.StructLike implements IRequestHeader {
    ...
    constructor(args: IRequestHeaderArgs = {}) {
        super();
        if (args.trace_id != null) {
            const value_66: thrift.Int64 = (typeof args.trace_id === "number" ? new thrift.Int64(args.trace_id) : typeof args.trace_id === "string" ? thrift.Int64.fromDecimalString(args.trace_id) : args.trace_id);
            this.trace_id = value_66;
        }
        if (args.span_id != null) {
            const value_67: thrift.Int64 = (typeof args.span_id === "number" ? new thrift.Int64(args.span_id) : typeof args.span_id === "string" ? thrift.Int64.fromDecimalString(args.span_id) : args.span_id);
            this.span_id = value_67;
        }
        if (args.parent_span_id != null) {
            const value_68: thrift.Int64 = (typeof args.parent_span_id === "number" ? new thrift.Int64(args.parent_span_id) : typeof args.parent_span_id === "string" ? thrift.Int64.fromDecimalString(args.parent_span_id) : args.parent_span_id);
        ...
        if (args.flags != null) {
            const value_71: thrift.Int64 = (typeof args.flags === "number" ? new thrift.Int64(args.flags) : typeof args.flags === "string" ? thrift.Int64.fromDecimalString(args.flags) : args.flags);
            this.flags = value_71;
        }
