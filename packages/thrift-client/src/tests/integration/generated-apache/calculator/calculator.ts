...
import { Operation as operation$Operation } from "./../operation/operation";
export type MyInteger = number;
export { operation$Operation as Operation };
...
export namespace Calculator {
    ...
    export class CalculateArgs {
        ...
        constructor(args: ICalculateArgsArgs) {
            ...
            if (args != null && args.w != null) {
                ...
                throw new thrift.Thrift.TProtocolException(thrift.Thrift.TProtocolExceptionType.UNKNOWN, "Required field w is unset!");
            }
        }
        public write(output: thrift.TProtocol): void {
            ...
            if (this.w != null) {
                output.writeFieldBegin("w", thrift.Thrift.Type.STRUCT, 2);
                this.w.write(output);
                output.writeFieldEnd();
            }
            output.writeFieldStop();
        ...
        public static read(input: thrift.TProtocol): CalculateArgs {
            ...
            while (true) {
                ...
                switch (fieldId) {
                    ...
                    case 2:
                        if (fieldType === thrift.Thrift.Type.STRUCT) {
                            const value_18: Work = Work.read(input);
                            _args.w = value_18;
                        }
                        else {
                            input.skip(fieldType);
            ...
            input.readStructEnd();
            if (_args.logid !== undefined && _args.w !== undefined) {
        ...
        public static read(input: thrift.TProtocol): EchoBinaryArgs {
            ...
            while (true) {
                ...
                switch (fieldId) {
                    case 1:
                        if (fieldType === thrift.Thrift.Type.STRING) {
                            const value_19: Buffer = input.readBinary();
                            _args.word = value_19;
                        }
                        else {
                            input.skip(fieldType);
        ...
        public static read(input: thrift.TProtocol): CheckNameArgs {
            ...
            while (true) {
                ...
                switch (fieldId) {
                    case 1:
                        if (fieldType === thrift.Thrift.Type.STRUCT) {
                            const value_21: Choice = Choice.read(input);
    ...
    export class MapOneListArgs {
        ...
        public write(output: thrift.TProtocol): void {
            ...
            if (this.arg != null) {
                ...
                this.arg.forEach((value_23: number): void => {
                    output.writeI32(value_23);
                });
                output.writeListEnd();
                output.writeFieldEnd();
            }
    ...
    export class MapValuesArgs {
        ...
        public write(output: thrift.TProtocol): void {
            ...
            if (this.arg != null) {
                ...
                this.arg.forEach((value_26: number, key_1: string): void => {
                    output.writeString(key_1);
                    output.writeI32(value_26);
                });
                output.writeMapEnd();
                output.writeFieldEnd();
            }
    ...
    export class ListToMapArgs {
        ...
        public write(output: thrift.TProtocol): void {
            ...
            if (this.arg != null) {
                ...
                this.arg.forEach((value_29: Array<string>): void => {
                    output.writeListBegin(thrift.Thrift.Type.STRING, value_29.length);
                    value_29.forEach((value_30: string): void => {
                        output.writeString(value_30);
                    });
                    output.writeListEnd();
                });
                output.writeListEnd();
        ...
        public static read(input: thrift.TProtocol): ListToMapArgs {
            ...
            while (true) {
                ...
                switch (fieldId) {
                    case 1:
                        if (fieldType === thrift.Thrift.Type.LIST) {
                            const value_31: Array<Array<string>> = new Array<Array<string>>();
                            const metadata_3: thrift.TList = input.readListBegin();
                            const size_3: number = metadata_3.size;
                            for (let i_3: number = 0; i_3 < size_3; i_3++) {
                                const value_32: Array<string> = new Array<string>();
        ...
        public static read(input: thrift.TProtocol): CalculateResult {
            ...
            while (true) {
                ...
                switch (fieldId) {
                    ...
                    case 1:
                        if (fieldType === thrift.Thrift.Type.STRUCT) {
                            const value_38: InvalidOperation = InvalidOperation.read(input);
                            _args.ouch = value_38;
                        }
                        else {
                            input.skip(fieldType);
    ...
    export class MapOneListResult {
        ...
        public write(output: thrift.TProtocol): void {
            ...
            if (this.success != null) {
                ...
                this.success.forEach((value_43: number): void => {
                    output.writeI32(value_43);
                });
                output.writeListEnd();
                output.writeFieldEnd();
            }
    ...
    export class MapValuesResult {
        ...
        public write(output: thrift.TProtocol): void {
            ...
            if (this.success != null) {
                output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
                output.writeListBegin(thrift.Thrift.Type.I32, this.success.length);
                this.success.forEach((value_46: number): void => {
        ...
        public static read(input: thrift.TProtocol): MapValuesResult {
            ...
            while (true) {
                ...
                switch (fieldId) {
                    case 0:
                        if (fieldType === thrift.Thrift.Type.LIST) {
                            const value_47: Array<number> = new Array<number>();
    ...
    export class ListToMapResult {
        ...
        public write(output: thrift.TProtocol): void {
            ...
            if (this.success != null) {
                ...
                this.success.forEach((value_49: string, key_3: string): void => {
        ...
        public static read(input: thrift.TProtocol): ListToMapResult {
            ...
            while (true) {
                ...
                switch (fieldId) {
                    case 0:
                        if (fieldType === thrift.Thrift.Type.MAP) {
                            const value_50: Map<string, string> = new Map<string, string>();
    ...
    export class Client extends shared$SharedService.Client {
        ...
        public calculate(logid: number, w: Work): Promise<number> {
            ...
            return new Promise<number>((resolve, reject): void => {
                ...
                this.send_calculate(logid, w, requestId);
            });
        }
        ...
        public send_calculate(logid: number, w: Work, requestId: number): void {
            const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    export interface ILocalHandler {
        ...
        calculate(logid: number, w: Work): number | Promise<number>;
        ...
        public process_calculate(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
            new Promise<number>((resolve, reject): void => {
                try {
                    ...
                    input.readMessageEnd();
                    resolve(this._handler.calculate(args.logid, args.w));
                }
                catch (err) {
                    reject(err);
                }
