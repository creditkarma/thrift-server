...
export class SharedStruct {
    ...
    public static read(input: thrift.TProtocol): SharedStruct {
        ...
        input.readStructEnd();
        if (_args.key !== undefined && _args.value !== undefined) {
            ...
            switch (fieldId) {
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRING) {
                        ...
                        _returnValue = SharedUnion.fromOption1(value_3);
                    }
                    else {
                        input.skip(fieldType);
                    }
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRING) {
                        ...
                        _returnValue = SharedUnion.fromOption2(value_4);
                    }
                    else {
                        input.skip(fieldType);
                    }
                ...
                switch (fieldId) {
                    case 0:
                        if (fieldType === thrift.Thrift.Type.STRUCT) {
                            const value_7: SharedStruct = SharedStruct.read(input);
        ...
        public static read(input: thrift.TProtocol): GetUnionResult {
            ...
            while (true) {
                ...
                switch (fieldId) {
                    case 0:
                        if (fieldType === thrift.Thrift.Type.STRUCT) {
                            const value_8: SharedUnion = SharedUnion.read(input);
